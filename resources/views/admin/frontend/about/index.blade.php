                ...
                <div class="card-body">
                    <form action="{{ route('admin.frontend.about.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" required rows="4" name="description" placeholder="@lang('Enter description')">{{ __($aboutContent->description) }}</textarea>
                            @error('description')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="button_name_one"
                                        value="{{ @$aboutContent->button_name_one }}" placeholder="@lang('Enter button name')">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="button_link_one"
                                        value="{{ @$aboutContent->button_link_one }}" placeholder="@lang('Enter link address')">
