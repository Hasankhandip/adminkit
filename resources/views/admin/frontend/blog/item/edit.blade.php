...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.frontend.blog.item.update', $frontendBlogItem->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                <input type="number" min="1" max="31" name="date" required
                                    class="form-control" value="{{ $frontendBlogItem->date }}">
                            </div>
                            <div class="col-lg-4 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" required name="title"
                                value="{{ $frontendBlogItem->title }}" placeholder="@lang('Enter title')">
                            @error('title')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" required name="blog_link"
                                value="{{ $frontendBlogItem->blog_link }}" placeholder="@lang('Enter blog link')">
                            @error('blog_link')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" required rows="4" name="description" placeholder="@lang('Enter description')">{{ $frontendBlogItem->description }}</textarea>
                            @error('description')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="button_name"
                                        value="{{ $frontendBlogItem->button_name }}" placeholder="@lang('Enter button name')">
                                    @error('button_name')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="button_link"
                                        value="{{ $frontendBlogItem->button_link }}" placeholder="@lang('Enter button link')">
                                    @error('button_link')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
