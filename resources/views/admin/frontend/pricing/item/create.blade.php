...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.frontend.pricing.item.store') }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" required name="name" value="{{ old('name') }}"
                                placeholder="@lang('Enter item name')">
                            @error('name')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="info_icon_one"
                                        value="{{ old('info_icon_one') }}" placeholder="@lang('Enter info icon ')">
                                    @error('info_icon_one')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="info_name_one"
                                        value="{{ old('info_name_one') }}" placeholder="@lang('Enter info name ')">
                                    @error('info_name_one')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="info_icon_two"
                                        value="{{ old('info_icon_two') }}" placeholder="@lang('Enter info icon ')">
                                    @error('info_icon_two')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="info_name_two"
                                        value="{{ old('info_name_two') }}" placeholder="@lang('Enter info name ')">
                                    @error('info_name_two')
                                        <p class="text-danger pt-2">{{ __($message) }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="info_icon_three"
                                        value="{{ old('info_icon_three') }}" placeholder="@lang('Enter info icon ')">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="info_name_three"
                                        value="{{ old('info_name_three') }}" placeholder="@lang('Enter info name ')">
