...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.frontend.testimonial.item.update', $frontendTestimonialItem->id) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" required name="name"
                                value="{{ $frontendTestimonialItem->name }}" placeholder="@lang('Enter name')">
                            @error('name')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" min="0" required name="designation"
                                value="{{ $frontendTestimonialItem->designation }}" placeholder="@lang('Enter designation')">
                            @error('designation')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" required rows="4" name="description" placeholder="@lang('Enter description')">{{ $frontendTestimonialItem->description }}</textarea>
                            @error('description')
                                <p class="text-danger pt-2">{{ __($message) }}</p>
                            @enderror
                        </div>
